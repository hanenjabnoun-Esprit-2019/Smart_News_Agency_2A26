...
void MainWindow::on_pushButton_clicked() //ajouter
{
    ...
    bool test=v.ajout_i();
    if(test)
    { QFile file("C:/Users/Dead_ops/Desktop/Historique.txt");
        ...
        QString message2="\nvous avez ajouté un invité ";
            cout << message2;
    QFile file1("C:/Users/Dead_ops/Desktop/Historique.txt");
